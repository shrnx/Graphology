      ...
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <Link to="/" className="flex items-center">
            <img
              src="E:\My Own Projects\Graphology\Graphology\src\Logo.png"
              className="mr-3 h-12"
              alt="Logo"
            />
          </Link>
              ...
              <li>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `block py-2 pr-4 pl-3 ${
                      isActive ? "text-green-700" : "text-gray-700"
                    } duration-200 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent text-center lg:border-0 hover:text-orange-700 lg:p-0`
                  }
                >
                  b
                </NavLink>
