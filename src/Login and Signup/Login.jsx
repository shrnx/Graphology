      ...
      <div className="h-5/6 flex justify-center items-center">
        <div className='flex items-center justify-center h-5/6 w-4/6'>
          <div className='bg-[#FFFFFF] text-center w-3/6 h-full p-12 rounded-2xl'>
            ...
            <Button color="warning" className='mt-6'>Login Now</Button>
            ...
            <button
              class="flex mt-4 items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
              <svg class="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
